/**
 * Title: AddSrvgInputBean.java
 * File Description: 新增服务组信息输入接口
 * @copyright: 2015
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description: 新增服务组信息输入接口
 * @author HT
 */
public class AddSrvgInputBean extends ActionRootInputBean{

	private static final long serialVersionUID = -7303341422202608731L;
