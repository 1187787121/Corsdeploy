/**
 * Title: QuerySrvgOutputBean.java
 * File Description: 查询服务组信息输出接口
 * @copyright: 2015
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description: 查询服务组信息输出接口
 * @author HT
 */
public class QuerySrvgOutputBean extends ActionRootOutputBean{

	private static final long serialVersionUID = 1751919703627363643L;
