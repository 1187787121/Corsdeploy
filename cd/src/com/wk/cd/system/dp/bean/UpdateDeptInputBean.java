/**
 * Title: UpdateDeptInputBean.java
 * File Description:  修改部门信息输入接口
 * @copyright: 2015
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description: 修改部门信息输入接口
 * @author HT
 */
public class UpdateDeptInputBean extends ActionRootInputBean{

	private static final long serialVersionUID = -712710393131209205L;
