/**
 * Title: AddDeptInputBean.java
 * File Description: 新增部门信息输入接口
 * @copyright: 2015
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description:新增部门信息输入接口
 * @author HT
 */
public class AddDeptInputBean extends ActionRootInputBean{

	private static final long serialVersionUID = -9141491324818601995L;
