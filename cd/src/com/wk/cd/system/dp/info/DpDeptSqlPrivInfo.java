...
@PrimaryKey({"dept_id","soc_name","tbl_name"})
public class DpDeptSqlPrivInfo implements Serializable  {
	private static final long serialVersionUID = 1L;

	/**
	 *表名称
	 */
	public static final String TABLECN = "部门SQL操作权限表";
