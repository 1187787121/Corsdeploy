/**
 * Title: PageTermInputBean.java
 * File Description: 查看终端输入信息
 * @copyright: 2015
 * @company: CORSWORK
 * @author: tlw
 * @version: 1.0
...
/**
 * Class Description: 查看终端输入信息
 * @author tlw
 */
public class PageTermInputBean
		extends PageQueryActionRootInputBean {

	private static final long serialVersionUID = -5460146326253345133L;
