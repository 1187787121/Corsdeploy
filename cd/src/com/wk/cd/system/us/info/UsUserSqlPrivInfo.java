...
@PrimaryKey({"user_id","soc_name","tbl_name","priv_type"})
public class UsUserSqlPrivInfo implements Serializable  {
	private static final long serialVersionUID = 1L;

	/**
	 *表名称
	 */
	public static final String TABLECN = "用户SQL操作权限表";
	...
	public String toString() {
		return "UsUserSqlPrivInfo [user_id=" + user_id + ", soc_name=" + soc_name + ", tbl_name=" + tbl_name + ", ins_priv_flag=" + ins_priv_flag + ", del_priv_flag="
				+ del_priv_flag + ", upd_priv_flag=" + upd_priv_flag + ", sel_priv_flag=" + sel_priv_flag + ", af_flag=" + af_flag + ", priv_type=" + priv_type
				+ ", tempstart_bk_datetime=" + tempstart_bk_datetime + ", tempend_bk_datetime=" + tempend_bk_datetime + ", backup_fld=" + backup_fld + "]";
	}
