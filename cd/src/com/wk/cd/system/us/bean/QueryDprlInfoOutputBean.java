/**
 * Title: QueryDprlInfoOutputBean.java
 * File Description: 查询部门角色详细信息输出接口
 * @copyright: 2015
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description: 查询部门角色详细信息输出接口
 * @author HT
 */
public class QueryDprlInfoOutputBean extends ActionRootOutputBean{

	private static final long serialVersionUID = 6413602721377478818L;
