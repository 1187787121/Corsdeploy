/**
 * Title: UpdateUserInputBean.java
 * File Description: 更改用户信息输入接口
 * @copyright: 2014
 * @company: CORSWORK
 * @author: link
 * @version: 1.0
...
/**
 * Class Description:更改用户信息输入接口
 * @author link
 */
public class UpdateUserInputBean
		extends ActionRootInputBean {

	private static final long serialVersionUID = 5794630583128710624L;
	 ...
	 * 部门是否更改标志
	 */
	private int dept_flag;
	
	public static final String DEPT_FLAGCN = "部门是否更改标志";
	...
	/**
	 * @return dept_flag 部门是否更改标志
	 */
	public int getDept_flag() {
		return this.dept_flag;
	}

	/**
	 * @param dept_flag 部门是否更改标志
	 */
	public void setDept_flag(int dept_flag) {
