/**
 * Title: UpdateUserTempSqlPrivInputBean.java
 * File Description: 修改用户临时Sql权限输入接口
 * @copyright: 2015
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description: 修改用户临时Sql权限输入接口
 * @author HT
 */
public class UpdateUserTempSqlPrivInputBean extends ActionRootInputBean{

	private static final long serialVersionUID = -7176766190700406445L;
	...
	public static final String SQL_LISTCN = "sql权限列表";
