...
import com.wk.cd.build.ea.action.DeleteInteProgStepAction;
 ...
 * @author chiss
 */
public class TestDeleteInteProgStepAction extends TestCase{
	private  DBSource db = DBSource.get();
	private  Session session;
	private Injector inject=Controller.getInstance().getInjector();
	private DeleteInteProgStepAction sc = inject.getBean(DeleteInteProgStepAction.class);
	...
	public void testDeleteInteProgStepAction(){
		DeleteInteProgStepInputBean input = new DeleteInteProgStepInputBean();
		commonInput(input);
		input.setProg_id("PG201612060025");
		input.setStep_id(1);
		sc.run(input);
	 ...
	 * @param input
	 */
	private void commonInput(DeleteInteProgStepInputBean input) {
		// 公共赋值
