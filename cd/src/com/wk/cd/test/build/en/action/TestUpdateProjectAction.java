/**
 * Title: TestUpdateProjectAction.java
 * File Description: 
 * @copyright: 2016
 * @company: CORSWORK
 * @author: xuph
...
import com.wk.cd.build.en.action.UpdateProjectAction;
 ...
 * @author xuph
 */
public class TestUpdateProjectAction extends TestCase{
	private  DBSource db = DBSource.get();
	private  Session session;
	private Injector inject=Controller.getInstance().getInjector();
	private UpdateProjectAction sc = inject.getBean(UpdateProjectAction.class);
	...
	public void testUpdateProject(){
		UpdateProjectInputBean input = new UpdateProjectInputBean();
		commonInput(input);
		input.setProject_name("wangjTest");
		input.setProject_bk_desc("wangjTest1");
		input.setProject_short_name("wangjTest1");
	 ...
	 * @param input
	 */
	private void commonInput(UpdateProjectInputBean input) {
		// 公共赋值
