 ...
 * File Description: 查看配置文件改动列表输入接口
 * @copyright: 2016
 * @company: CORSWORK
 * @author: chiss
 * @version: 1.0
...
/**
 * Class Description: 查看配置文件改动列表输入接口
 * @author chiss
 */
public class ViewBuildTaskInputBean extends ActionRootInputBean{
	...
	public static final String BUILD_STEP_IDCN = "构建步骤数";
	...
	public static final String SCRIPT_TYPE_LISTCN = "脚本类型列表";
