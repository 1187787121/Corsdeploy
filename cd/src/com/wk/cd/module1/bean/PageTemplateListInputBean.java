...
public class PageTemplateListInputBean extends PageQueryActionRootInputBean {
	
	private static final long serialVersionUID = -5007425888651337313L;
	...
	public static final String ORDER_COL_NAMECN = "≈≈–Ú◊÷∂Œ";
	...
	public static final String ORDER_TYPECN = "≈≈–Ú¿‡–Õ";

	public String getOrder_col_name() {
		return this.order_col_name;
	}
