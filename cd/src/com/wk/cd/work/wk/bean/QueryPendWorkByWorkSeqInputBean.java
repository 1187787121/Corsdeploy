 ...
 * File Description:待处理流水号查询任务信息输入接口
 * @copyright: 2014
 * @company: CORSWORK
 * @author: tlw
 * @version: 1.0
...
/**
 * Class Description:待处理流水号查询任务信息输入接口
 * @author tlw
 */
public class QueryPendWorkByWorkSeqInputBean
		extends ActionRootInputBean {

	private static final long serialVersionUID = 2070057054363462927L;
