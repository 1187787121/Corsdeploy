/**
 * Title: UncheckWorkBean.java
 * File Description: 由我申请的任务
 * @copyright: 2016
 * @company: CORSWORK
 * @author: Xul
 * @version: 1.0
...
public class MineWorkBean {
	 ...
	 *待处理用户
	 */
	private String pend_cn_name;

	public static final String PEND_CN_NAMECN = "待处理用户";
	...
	/**
	 * @return pend_cn_name 待处理用户
	 */
	public String getPend_cn_name() {
		return pend_cn_name;
	}

	/**
	 * @param pend_cn_name 待处理用户
	 */
	public void setPend_cn_name(String pend_cn_name) {
		this.pend_cn_name = pend_cn_name;
	}
