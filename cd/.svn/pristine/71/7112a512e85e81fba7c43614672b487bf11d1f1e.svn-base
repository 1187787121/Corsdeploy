...
drop table INSTANCE_EXE;

drop table MO_MODULE;

drop table MO_MODULE_QUOTE;

drop table MO_COMPONENT;

drop table MO_TEMPLATE;
...
drop table US_ROLE_ENV_PRIV;

drop table US_USER_ENV_PRIV;
...
(
   FILE_WORK_SEQ        VARCHAR(17)            not null,
   WORK_ID              VARCHAR(14),
...
(
   WORK_ID              VARCHAR(14)            not null,
   SCRIPT_TYPE          INTEGER                not null default 0,
   SCIRPT_BK_SEQ        BIGINT                 not null default 0,
   SCRIPT_METHOD        INTEGER                default 0,
   MODULE_ID            VARCHAR(20),
   MODULE_CN_NAME       VARCHAR(50),
   SOC_UUID             CHAR(32),
...
(
   ...
   ENV_BK_DESC          VARCHAR(200),
   ENV_TYPE             INTEGER                not null default 0,
   SYS_NAME             CHAR(20),
   ELE_TYPE             VARCHAR(20),
...
(
   ...
   SERVER_IP            VARCHAR(20),
   SERVER_OS            INTEGER                not null default 0,
   OS_SBK_VER           VARCHAR(20),
   SERVER_DB            VARCHAR(200),
   SERVER_MID_WARE      VARCHAR(20),
   CREATE_BK_DATE       DATE,
   CREATE_BK_TIME       TIME,
   CREATE_USER_ID       VARCHAR(20),
   MODIFY_BK_DATE       DATE,
...
(
   ...
   SYS_NAME             CHAR(20),
   BACKUP_FLD           VARCHAR(50),
   constraint "P_Key_1" primary key (DEPT_ID, ENV_NAME)
);
...
(
   ...
   FOPT_TYPE            INTEGER                not null default 0,
   FILE_BK_PATH         VARCHAR(200),
   FILE_BK_FNAME        VARCHAR(50),
   FILE_BK_CSUM         VARCHAR(20),
   DIR_YN_FLAG          INTEGER                not null default 0,
   OPT_STATUS           INTEGER                not null default 0,
   MODIFY_USER_ID       VARCHAR(20),
   MODIFY_BK_DATE       DATE,
   MODIFY_BK_TIME       TIME,
   BACKUP_FLD           VARCHAR(50),
...
(
   STORAGE_ID           VARCHAR(14)            not null,
   STORAGE_BK_DESC      VARCHAR(200),
   ENV_NAME             VARCHAR(20),
   ...
   INTE_VER_NUM         VARCHAR(50),
   TAR_VER_NUM          VARCHAR(50),
   STORAGE_STATUS       INTEGER                default 0,
   CRT_USER_ID          VARCHAR(20),
   STORAGE_RESULT       INTEGER                default 0,
   CRT_BK_DATE          DATE,
   CRT_BK_TIME          TIME,
   STORAGE_USER_ID      VARCHAR(20),
   START_BK_TM          TIMESTAMP,
   END_BK_TM            TIMESTAMP,
...
(
   ...
   TASK_BK_DESC         VARCHAR(200),
   ROL_WORK_ID          VARCHAR(14),
   ENV_NAME             VARCHAR(20),
   PROJECT_NAME         VARCHAR(100),
   PROG_ID              VARCHAR(14),
   INSTANCE_ID          VARCHAR(50),
   ...
   CODE_VER_NUM         VARCHAR(50),
   TARGET_VER_NUM       VARCHAR(50),
   VERCODE_VER_NUM      VARCHAR(50),
   VERTARGET_VER_NUM    VARCHAR(50),
   TASK_STATUS          INTEGER                default 0,
   EXE_RESULT           INTEGER                default 0,
   EXELOG_BK_PATH       VARCHAR(200),
   CRT_USER_ID          VARCHAR(20),
...
(
   ...
   INST_BK_NO           INTEGER                not null default 0,
   ...
   END_BK_TM            TIMESTAMP,
   TIME_USED            INTEGER                default 0,
   constraint "P_Key_1" primary key (INSTANCE_ID, INST_BK_NO)
);
...
(
   MODULE_ID            VARCHAR(20)            not null,
   QUOTE_MODULE_ID      VARCHAR(20)            not null,
   QUOTE_MODULE_TYPE    INTEGER                default 0,
   constraint "P_Key_1" primary key (MODULE_ID, QUOTE_MODULE_ID)
);
...
(
   ...
   COMPONENT_CN_NAME    VARCHAR(50),
   COMPONENT_BK_DESC    VARCHAR(500),
   MODULE_TYPE          INTEGER                default 0,
   COMPONENT_PURPOSES   VARCHAR(10),
   ...
   MODIFY_BK_TIME       TIME,
   BACKUP_FLD           VARCHAR(50),
   constraint "P_Key_1" primary key (COMPONENT_ID)
);
...
(
   ...
   PROG_TYPE            INTEGER                not null default 0,
...
(
   PROG_ID              VARCHAR(14)            not null,
   PUB_TEMPLATE_NAME    VARCHAR(50),
   PUBL_PARAM_UUID      CHAR(32),
   ROL_TEMPLATE_NAME    VARCHAR(50),
...
(
   ...
   IMPL_TYPE            INTEGER                not null default 0,
...
(
   ...
   SYS_NAME             CHAR(20),
   BACKUP_FLD           VARCHAR(50),
   constraint "P_Key_1" primary key (DPRL_CODE, ENV_NAME)
);
...
(
   ...
   BACKUP_FLD           VARCHAR(50),
   constraint "P_Key_1" primary key (USER_ID, ENV_NAME, PRIV_TYPE)
);
...
(
   ...
   SERVER_NAME          VARCHAR(20),
   STORAGE_BK_PATH      VARCHAR(200),
   TARGET_RELATIVE_PATH VARCHAR(200),
...
(
   SOC_UUID             CHAR(32)               not null,
   SOC_BK_SEQ           BIGINT                 not null default 0,
   EXE_SERVER_NAME      VARCHAR(20),
   EXE_SOC_NAME         VARCHAR(20),
   VER_SERVER_NAME      VARCHAR(20),
   VER_SOC_NAME         VARCHAR(20),
   CODE_BK_DIR          VARCHAR(100),
   constraint "P_Key_1" primary key (SOC_UUID, SOC_BK_SEQ)
);
...
(
   ...
   ORG_TERM_NO          VARCHAR(40),
   ORG_WORK_CODE        VARCHAR(10),
   ORG_SRV_NAME         VARCHAR(50),
   ORG_SRV_BK_DESC      VARCHAR(100),
   ORG_RS_CODE          VARCHAR(10),
   ORG_ARY_SOCNAME      VARCHAR(100),
   PEND_WORK_SEQ        VARCHAR(17),
   PEND_WORK_CODE       VARCHAR(10),
   PEND_SRV_NAME        VARCHAR(50),
   PEND_RS_CODE         VARCHAR(10),
...
(
   WORK_SEQ             VARCHAR(17)            not null,
   RC_USER_ID           VARCHAR(20)            not null,
...
(
   OPT_CODE             VARCHAR(12)            not null,
   BL_RS_CODE           VARCHAR(10),
   OPT_BK_SEQ           BIGINT                 not null default 0,
   OPT_NAME             VARCHAR(50),
...
(
   ...
   PUBLIC_YN_FLAG       INTEGER                not null default 0,
...
(
   ...
   PROC_NUM             VARCHAR(10),
   BL_USER_ID           VARCHAR(20),
   RUN_CMD_STR          VARCHAR(500),
   ORG_USER_ID          VARCHAR(20),
...
(
   ...
   LOG_LEVEL            INTEGER                not null default 0,
   RCD_STATE            INTEGER                not null default 0,
   APROV_TYPE           INTEGER                not null default 0,
   CUSTOM_RS_CODE       VARCHAR(10),
...
(
   ...
   SUPER_FLAG           INTEGER                not null default 0,
...
(
   USER_ID              VARCHAR(20)            not null,
   DPRL_CODE            CHAR(8)                not null,
   USER_BK_WEIGHT       INTEGER                not null default 0,
   BACKUP_FLD           VARCHAR(50),
...
(
   ...
   PEND_USER_ID         VARCHAR(20),
   PEND_USER_CN_NAME    VARCHAR(50),
   PBL_CODE             VARCHAR(20),
   PROXY_USER_ID        VARCHAR(20),
...
(
   ...
   PEND_USER_ID         VARCHAR(20),
   PEND_USER_CN_NAME    VARCHAR(50),
   PEND_TYPE            INTEGER                not null default 0,
   constraint "P_Key_1" primary key (PEND_WORK_SEQ, DEAL_SEQ)
);
