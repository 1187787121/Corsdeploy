/**
 * Title: AddSocInputBean.java
 * File Description: 添加数据源输入接口
 * @copyright: 2014
 * @company: CORSWORK
 * @author: link
 * @version: 1.0
...
/**
 * Class Description: 添加数据源输入接口
 * @author link
 */
public class AddSocInputBean
		extends ActionRootInputBean {

	private static final long serialVersionUID = -7847066930969346609L;
