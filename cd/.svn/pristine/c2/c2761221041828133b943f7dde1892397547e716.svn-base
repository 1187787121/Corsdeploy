/**
 * Title: GetDictOutputBean.java
 * File Description: 查询数据字典详细信息输出接口
 * @copyright: 2014
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description: 查询数据字典详细信息输出接口类
 * @author HT
 */
public class GetDictOutputBean extends ActionRootOutputBean{
	/** 
	 * 
	 */ 
	private static final long serialVersionUID = 40263365869756851L;
	/**
	 *  域名称
	 */
	...
	public static final String FLD_LENGTHCN="长度";
	...
	public static final String IS_ENUCN="是否枚举";
	
	/**
	 * 枚举列
	 */
	private List<DcDictEnuInfo> enu_list;
	public static final String ENU_LISTCN="枚举列";
	/**
