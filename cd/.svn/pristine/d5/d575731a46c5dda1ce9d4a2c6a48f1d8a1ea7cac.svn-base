/**
 * Title: QueryDprlInfoInputBean.java
 * File Description: 查询部门角色详细信息输入接口
 * @copyright: 2015
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description: 查询部门角色详细信息输入接口
 * @author HT
 */
public class QueryDprlInfoInputBean extends ActionRootInputBean{

	private static final long serialVersionUID = 7075783583955564328L;
