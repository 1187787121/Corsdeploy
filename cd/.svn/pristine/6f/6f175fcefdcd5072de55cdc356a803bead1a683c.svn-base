/**
 * Title: AddCeSystemInputBean.java
 * File Description: 
 * @copyright: 2016
 * @company: CORSWORK
 * @author: chiss
...
/**
 * Class Description: 新增应用系统输入接口
 * @author chiss
 */
public class AddSystemInputBean extends ActionRootInputBean{
	
	/** 
	 * @Fields serialVersionUID : TODO
	 */ 
	private static final long serialVersionUID = -279583654636633965L;
