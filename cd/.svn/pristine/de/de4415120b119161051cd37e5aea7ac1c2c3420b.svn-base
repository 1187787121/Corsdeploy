/**
 * Title: UpdateChannelInputBean.java
 * File Description: 修改渠道信息输入接口
 * @copyright: 2015
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description: 修改渠道信息输入接口
 * @author HT
 */
public class UpdateChannelInputBean extends ActionRootInputBean{

	private static final long serialVersionUID = 1197623508905207078L;
