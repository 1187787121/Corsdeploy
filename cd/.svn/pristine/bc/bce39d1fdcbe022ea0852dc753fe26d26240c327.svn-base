 ...
 * File Description: 校验发布文件清单和投产包输入接口(APP)
 * @copyright: 2017
 * @company: CORSWORK
 * @author: Xul
 * @version: 1.0
...
/**
 * Class Description: 校验发布文件清单和投产包输入接口(APP)
 * @author Xul
 */
public class CheckPublishListAndPacForAppInputBean extends ActionRootInputBean{
	...
	public static final String PAC_LISTCN = "投产包列表";
