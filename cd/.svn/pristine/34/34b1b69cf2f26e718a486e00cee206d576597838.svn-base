...
@PrimaryKey({"dprl_code","soc_name","tbl_name","col_name"})
public class UsRoleColPrivInfo implements Serializable  {
	private static final long serialVersionUID = 1L;

	/**
	 *表名称
	 */
	public static final String TABLECN = "部门角色SQL字段操作权限表";
