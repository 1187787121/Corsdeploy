/**
 * Title: AddWorkInputBean.java
 * File Description:新增任务输入接口 
 * @copyright: 2014
 * @company: CORSWORK
 * @author: tlw
 * @version: 1.0
...
/**
 * Class Description:新增任务输入接口
 * @author tlw
 */
public class AddWorkInputBean
		extends ActionRootInputBean {

	private static final long serialVersionUID = 135727151681687294L;
