...
public class MoModuleInfo
	 ...
	 * 表名称
	 */
	public static final String TABLECN = "组件信息表";
	...
	public static final String MODULE_PURPOSESCN = "组件用途";
	...
	public static final String SCRIPT_SOURCECN = "脚本来源";
	...
	public static final String IMPL_TYPECN = "组件实现类型";
