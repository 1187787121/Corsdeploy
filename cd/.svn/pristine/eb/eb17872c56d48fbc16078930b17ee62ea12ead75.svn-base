...
import com.wk.cd.enu.SERVER_DB;
 ...
 * @author AutoGen
 */
@Table("VI_SYS_ENV_SERVER")
public class ViSysEnvServerInfo implements Serializable  {
	private static final long serialVersionUID = 1L;

	/**
	 *表名称
	 */
	public static final String TABLECN = "VIEW";
	 ...
	 *中间件
	 */
	private MID_WARE server_mid_ware;
	 ...
	 */
	public void setServer_db(SERVER_DB server_db) {
	 ...
	 */
	public MID_WARE getServer_mid_ware() {
	 ...
	 */
	public void setServer_mid_ware(MID_WARE server_mid_ware) {
