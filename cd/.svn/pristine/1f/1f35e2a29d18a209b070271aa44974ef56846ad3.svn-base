/**
 * Title: DelayTempColInputBean.java
 * File Description: 临时col权限申请延期输入接口
 * @copyright: 2016
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description: 临时col权限申请延期输入接口
 * @author HT
 */
public class DelayTempColInputBean extends ActionRootInputBean{

	private static final long serialVersionUID = -9012662381670980007L;
