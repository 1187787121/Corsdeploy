/**
 * Title: TestCompleteBuildTaskAction.java
 * File Description: 
 * @copyright: 2016
 * @company: CORSWORK
 * @author: wangj
...
import com.wk.cd.build.ea.action.CompleteBuildTaskAction;
 ...
 * @author wangj
 */
public class TestCompleteBuildTaskAction extends TestCase{
	private DBSource db = DBSource.get();
	private Session session;
	private Injector inject=Controller.getInstance().getInjector();
	private CompleteBuildTaskAction sc = inject.getBean(CompleteBuildTaskAction.class);
	...
	public void test1() {
		CompleteBuildTaskInputBean input = new CompleteBuildTaskInputBean();
	 ...
	 * @param input
	 */
	private void commonInput(CompleteBuildTaskInputBean input) {
		// 公共赋值
