/**
 * Title: UpdateServerOutputBean.java
 * File Description: 修改服务器Action输入接口
 * @copyright: 2016
 * @company: CORSWORK
 * @author: yangl
 * @version: 1.0
...
/**
 * Class Description: 修改服务器Action输入接口
 * @author yangl
 */
public class UpdateServerInputBean
	...
	public static final String SOC_LIST_CN = "数据源列表";
