/**
 * Title: UpdateDictInputBean.java
 * File Description: 修改数据字典详细信息输入接口
 * @copyright: 2014
 * @company: CORSWORK
 * @author: HT
 * @version: 1.0
...
/**
 * Class Description:修改数据字典详细信息输入接口类 
 * @author HT
 */
public class UpdateDictInputBean extends ActionRootInputBean{
	/** 
	 * 
	 */ 
	private static final long serialVersionUID = 4007991940067451363L;
	/**
	 * 域名称
	 */
	private String domain_name; 
	public static final String DOMAIN_NAMECN="域名称_V";
	
	/**
	 * 域中文名称
	 */
	private String domain_cn_name;
	public static final String DOMAIN_CN_NAMECN="域中文名称_V";
	
	/**
	 * 类型
	 */
	private String fld_type;
	public static final String FLD_TYPECN="类型_V";
	
	/**
	 * 长度
	 */
	private int fld_length;
	public static final String FLD_LENGTHCN="长度_V";
	
	/**
	 * 小数位
	 */
	private int fld_scale;
	public static final String FLD_SCALECN="小数位_V";
	
	/** 
	 * 是否枚举
	 */ 
	private YN_FLAG is_enu;
	public static final String IS_ENUCN="是否枚举_V";
	
	/**
	 * 枚举列
	 */
	private List<DcDictEnuInfo> enu_list;
	public static final String ENU_LISTCN="枚举列_V";
	/**
	 ...
	 * @return is_enu
	 */
	public YN_FLAG getIs_enu() {
		return this.is_enu;
	}
	/**
	 * @param is_enu
	 */
	public void setIs_enu(YN_FLAG is_enu) {
		this.is_enu = is_enu;
	}
	/**
	 * @return enu_list 枚举列
	 */
	public List<DcDictEnuInfo> getEnu_list() {
		return this.enu_list;
	}
	/**
	 * @param enu_list 枚举列
	 */
	public void setEnu_list(List<DcDictEnuInfo> enu_list) {
